...
|------|---------|-----------|
| <img src="public/ecr.png" width="24" height="24" alt="ECR" /> | **Amazon ECR** | Registry de imagens Docker. O build da API é enviado ao ECR e o Kubernetes (K3s) faz pull da imagem para os pods. |
| <img src="public/s3.png" width="24" height="24" alt="S3" /> | **Amazon S3** | Bucket para armazenar os arquivos CSV da importação. O upload é feito pela API e o job Sidekiq processa o arquivo a partir do S3. |
